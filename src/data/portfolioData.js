export const portfolioData = {
  ...
  skills: [
    { id: 0, name: "JavaScript", icon: "js.png" },
    { id: 1, name: "HTML", icon: "html.png" },
    { id: 2, name: "CSS", icon: "css.png" },
    { id: 3, name: "React", icon: "react.png" },
    { id: 4, name: "Redux", icon: "redux.png" },
    { id: 5, name: "Tailwind CSS", icon: "tailwind.svg" },
    { id: 6, name: "Jest", icon: "jest.png" },
    { id: 7, name: "Git", icon: "git.png" },
    { id: 8, name: "Jira", icon: "jira.png" },
    { id: 9, name: "Parcel", icon: "parcel.png" },
    { id: 10, name: "GSAP", icon: "gsap.svg" },
    { id: 11, name: "VS Code", icon: "vs.png" },
    { id: 12, name: "Node Js", icon: "nodejs.png" },
    { id: 13, name: "Microsoft Azure", icon: "azure.png" },
    { id: 14, name: "Bitbucket", icon: "bitbucket.png" },
    { id: 15, name: "Tanstack Query", icon: "tanstack.png" },
    { id: 16, name: "Express Js", icon: "expressjs.png" },
